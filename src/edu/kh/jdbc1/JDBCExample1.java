...
public class JDBCExample1 {
	...
	public static void main(String[] args) {
		...
		// * JDBC 를 이용한 애플리케이션을 만들때 필요한 것
		// 1. Java의 JDBC 관련 인터페이스
		// 2. DBMS(Oracle)
		// 3. Oracle 에서 Java 애플리케이션과 연결할 때 사용할
		//     jdbc를 상속바당 구현한 클래스 모음 (ojdbc1.jar 라이브러리)
		//		-> OracleDrive.class 이용 (JDBC 드라이버)
		
		//1 단계 : Jdbc 객체 참조 변수 선언 (java.sql 패키지의 인터페이스)
		
		Connection conn = null;
		// DB 연결 정보를 담은 객체
		// -> dmbs 타입, 이름 ip, port, 계정명, 비밀번호 지정
